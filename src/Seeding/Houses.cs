...
public static class Houses
{
    ...
    public static readonly House House2 = House.Create(
        ...
        new List<Room>
        {
            new()
            {
                ...
                Name = "Restroom",
                HouseId = Guid.Parse("2D6DEA12-F724-45AD-ADFB-C04703A41805")
            },
            new()
            {
    ...
    public static readonly House House3 = House.Create(
        ...
        new List<Room>
        {
            new()
            {
                ...
                Name = "Restroom",
                HouseId = Guid.Parse("37F05632-8C35-4AFE-A472-F3A57924D0B8")
            }
        });
    ...
    public static IEnumerable<House> GetSeededHousesWithoutNavigations()
    {
        return typeof(Houses)
            .GetFields()
            .Select(field => field.GetValue(null)).Cast<House>()
    ...
    public static IEnumerable<Room> GetSeededRoomsFromHouses()
    {
        return typeof(Houses)
            .GetFields()
            .Select(field => field.GetValue(null)).Cast<House>()
            .Select(x => new {Rooms = x.Rooms, HouseId = x.Id})
