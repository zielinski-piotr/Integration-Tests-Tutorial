...
public class HouseServiceTests
{
    ...
    public async Task GetHouseById_Should_Return_House(DomainModelHouse seededHouse)
    {
        // Arrange
        _repository.Setup(x => x.Get<DomainModelHouse>())
    ...
    [Fact]
    public async Task GetHouseById_Should_Throw_ArgumentException_WhenPassingEmptyGuid()
    {
        // Act + Assert
        var exception =
            await Assert.ThrowsAsync<ArgumentException>(async () => await _houseService.GetHouseById(Guid.Empty));
        Assert.Equal("id", exception.Message);
    }
    ...
    public async Task GetHouseById_Should_Throw_NotFoundException_WhenHouseNotFound()
    {
        ...
        var exception =
            await Assert.ThrowsAsync<KeyNotFoundException>(async () =>
                await _houseService.GetHouseById(Guid.NewGuid()));
    ...
    public async Task GetHouseById_Should_Pass_Exception_Further()
    {
        ...
        // Act + Assert
        var exception =
            await Assert.ThrowsAsync<Exception>(async () => await _houseService.GetHouseById(Guid.NewGuid()));
    ...
    public async Task UpdateHouse_Should_UpdateEntity_Successfully()
    {
        ...
        _repository.Setup(x => x.Update(It.IsAny<DomainModelHouse>()));
        ...
        //Assert
        _repository.Verify(x => x.Get<DomainModelHouse>());
        _repository.Verify(x =>
            x.Update(It.Is<DomainModelHouse>(house => house.Address.Street.Equals(NewStreetName))));
    ...
    public async Task UpdateHouse_Should_Throw_JsonPatchException_When_Patching_Not_Existing_Property()
    {
        ...
        _repository.Verify(x => x.Get<DomainModelHouse>());
        _repository.Verify(x =>
            x.Update(It.IsAny<DomainModelHouse>()), Times.Never);
    ...
    public async Task UpdateHouse_Should_Set_Property_Value_To_Null_When_Remove_Operation_Used_On_Reference_Type()
    {
        ...
        _repository.Verify(x => x.Get<DomainModelHouse>());
        _repository.Verify(x =>
            x.Update(It.Is<DomainModelHouse>(house => house.Address.Street == null)));
        _repository.Verify(x => x.SaveChangesAsync());
    }
    ...
    public async Task UpdateHouse_Should_Set_Property_Value_To_Default_When_Remove_Operation_Used_On_Value_Type()
    {
        ...
        _repository.Verify(x => x.Get<DomainModelHouse>());
        _repository.Verify(x =>
            x.Update(It.Is<DomainModelHouse>(house => house.Area == default)));
        _repository.Verify(x => x.SaveChangesAsync());
    }
    ...
    public async Task UpdateHouse_Should_Throw_ArgumentNullException_When_Update_Definition_Null()
    {
        ...
        _repository.Verify(x => x.Get<DomainModelHouse>(), Times.Never);
        _repository.Verify(x =>
            x.Update(It.IsAny<DomainModelHouse>()), Times.Never);
        _repository.Verify(x => x.SaveChangesAsync(), Times.Never);
    }
    ...
    public async Task UpdateHouse_Should_Update_Entity_When_Update_Definition_Is_Valid()
    {
        ...
        //Assert
        _repository.Verify(x => x.Get<DomainModelHouse>(), Times.Once);
        _repository.Verify(x =>
            x.Update(It.Is<DomainModelHouse>(house =>
    ...
    public async Task RemoveHouseById_Should_Throw_ArgumentException_When_Id_Is_Empty()
    {
        ...
        _repository.Setup(x => x.Remove(It.IsAny<DomainModelHouse>()));
    ...
    public async Task RemoveHouseById_Should_Throw_KeyNotFoundException_When_Entity_Not_Found()
    {
        ...
        _repository.Verify(x => x.Get<DomainModelHouse>(), Times.Once);
        _repository.Verify(x =>
            x.Remove(It.IsAny<DomainModelHouse>()), Times.Never);
        _repository.Verify(x => x.SaveChangesAsync(), Times.Never);
    }
    ...
    public async Task RemoveHouseById_Should_Call_Remove_On_Repository_To_Remove_Entity()
    {
        ...
        _repository.Verify(x => x.Get<DomainModelHouse>(), Times.Once);
        _repository.Verify(x =>
            x.Remove(It.Is<DomainModelHouse>(house => house == Houses.House1)), Times.Once);
        _repository.Verify(x => x.SaveChangesAsync(), Times.Once);
    }
    ...
    {
        //Arrange
        _repository.Setup(x => x.Add(It.IsAny<DomainModelHouse>()));
        ...
        //Assert
        _repository.Verify(x =>
            x.Add(It.Is<DomainModelHouse>(house => house.Area == houseRequest.Area &&
    ...
    public void CreateHouse_Should_Throw_ArgumentNullException_When_Request_IsNull()
    {
        ...
        _repository.Verify(x =>
            x.Add(It.IsAny<DomainModelHouse>()), Times.Never);
        _repository.Verify(x => x.SaveChangesAsync(), Times.Never);
    }
